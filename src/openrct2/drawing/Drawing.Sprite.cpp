...
bool gfx_load_g1(const IPlatformEnvironment& env)
{
    ...
    try
    {
        ...
        _g1.header.num_entries = ORCT_ensure_value_is_little_endian32(_g1.header.num_entries);
        _g1.header.total_size = ORCT_ensure_value_is_little_endian32(_g1.header.total_size);
...
bool gfx_load_g2()
{
    ...
    try
    {
        ...
        _g2.header.num_entries = ORCT_ensure_value_is_little_endian32(_g2.header.num_entries);
        _g2.header.total_size = ORCT_ensure_value_is_little_endian32(_g2.header.total_size);
